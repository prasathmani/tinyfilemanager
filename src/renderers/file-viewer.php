                    ...
                    if (in_array($ext, $word_exts, true)) {
                        if ($docx_preview_mode !== 'local') {
                            ...
                            echo '<script>'
                                ...
                                .         '}else{'
                                .           'wrap.innerHTML="<p style=\'padding:16px;color:red;\'>"+txtLibErr+"</p>";'
                                .         '}'
                                .       '})'
                                .       '.catch(function(e){if(msg){msg.textContent=txtLoadErr+": "+e;}});'
                                .   '}'
                                ...
                                .     's.onload=run;'
                                .     's.onerror=function(){if(msg){msg.textContent=txtLibErr;}};'
