...
render_layout([
    'title' => 'Správa užívateľov | DREMONT',
    'content' => $content,
    'extra_head' => '<style>.admin-table { width: 100%; border-collapse: collapse; margin-top: 2rem; } .admin-table th, .admin-table td { border: 1px solid #ccc; padding: 8px; } .admin-table th { background: #f0f0f0; } .admin-actions { display: flex; gap: 8px; }</style>',
]);
